...
<div class="comments-index">
    ...
    <div class="text-end mb-4">
        <?= Html::a('💬 Create New Comment', ['create'], ['class' => 'btn btn-success shadow-sm', 'style' => 'color: black;']) ?>
    </div>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'buttons' => [
                    'view' => fn($url) => Html::a('👁', $url, ['class' => 'btn btn-sm btn-outline-info', 'title' => 'View Comment']),
                    'update' => fn($url) => Html::a('✏️', $url, ['class' => 'btn btn-sm btn-outline-warning', 'title' => 'Edit Comment']),
                ...
                'urlCreator' => function ($action, Comments $model) {
