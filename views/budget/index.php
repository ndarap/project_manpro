...
<div class="budget-index">
    ...
    <div class="text-end mb-4">
        <?= Html::a('💰 Create Budget', ['create'], ['class' => 'btn btn-success shadow-sm', 'style' => 'color: black;']) ?>
    </div>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'buttons' => [
                    'view' => fn($url) => Html::a('👁', $url, ['class' => 'btn btn-sm btn-outline-info', 'title' => 'View Budget']),
                    'update' => fn($url) => Html::a('✏️', $url, ['class' => 'btn btn-sm btn-outline-warning', 'title' => 'Edit Budget']),
                ...
                'urlCreator' => function ($action, Budget $model) {
