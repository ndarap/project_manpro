...
<div class="users-index">
    ...
    <div class="text-end mb-4">
        <?= Html::a('➕ Create New User', ['create'], ['class' => 'btn btn-success shadow-sm', 'style' => 'color: black;']) ?>
    </div>
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'buttons' => [
                    'view' => fn($url) => Html::a('👁', $url, ['class' => 'btn btn-sm btn-outline-info', 'title' => 'View User']),
                    'update' => fn($url) => Html::a('✏️', $url, ['class' => 'btn btn-sm btn-outline-warning', 'title' => 'Edit User']),
